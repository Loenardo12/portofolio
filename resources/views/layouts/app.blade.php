...
<head>
    <meta charset="utf-8">
    {{-- <title>{{ config('app.name', 'Leonardo') }}</title> --}}
    ...
    <link rel="shortcut icon" href="{{ asset('import/assets/img/favicon.ico') }}">
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        <a href="index.html" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><span class="text-primary">Porto</span>Folio</h1>
        </a>
        ...
        <div class="collapse navbar-collapse px-lg-3" id="navbarCollapse">
            ...
            <a href="/admin" class="btn btn-outline-primary d-none d-lg-block">login</a>
        </div>
    </nav>
    <!-- Navbar End -->
